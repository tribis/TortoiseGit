...
#define DEFAULTMENUTOPENTRIES	MENUCREATEREPOS|MENUCLONE|MENUPULL|MENULOG|MENUCOMMIT|MENUADD|MENUDIFF
#define DEFAULTMENUEXTENTRIES	MENUSVNIGNORE|MENUSTASHAPPLY|MENUSUBSYNC|MENUDAEMON|MENUREFLOG|MENUREBASE|MENUBISECT|MENUREMOVEKEEP|MENUCLEANUP|MENUTAG|MENUSUBADD|MENUUPDATEEXT|MENUFORMATPATCH|MENUIMPORTPATCH|MENUAPPLYPATCH|MENUSENDMAIL|MENUBLAME|MENUSYNC
